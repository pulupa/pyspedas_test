...
# User the USER and PSP_STAGING_PW environment variables to
# access non-public PSP data from the SSL 

pyspedas.psp.fields(trange=['2022-04-19','2022-04-20'],
                    datatype='rfs_rawspectra',level = 'l1',
                    username = environ.get('USER'),  password=environ.get('PSP_STAGING_PW'),
